...
TEST(Matrix3x3Tests, MultiplicationOperator) {
	...
	{
		// r0c0
		const float expR0C0 = randomMatrix1(0, 0) * randomMatrix2(0, 0) + // a * j
		...
		// r0c1
		const float expR0C1 = randomMatrix1(0, 0) * randomMatrix2(0, 1) + // a * k
		...
		// r0c2
		const float expR0C2 = randomMatrix1(0, 0) * randomMatrix2(0, 2) + // a * l
	...
	{
		// r1c0
		const float expR1C0 = randomMatrix1(1, 0) * randomMatrix2(0, 0) + // d * j
		...
		// r1c1
		const float expR1C1 = randomMatrix1(1, 0) * randomMatrix2(0, 1) + // d * k
		...
		// r1c2
		const float expR1C2 = randomMatrix1(1, 0) * randomMatrix2(0, 2) + // d * l
	...
	{
		// r2c0
		const float expR2C0 = randomMatrix1(2, 0) * randomMatrix2(0, 0) + // g * j
		...
		// r2c1
		const float expR2C1 = randomMatrix1(2, 0) * randomMatrix2(0, 1) + // g * k
		...
		// r2c2
		const float expR2C2 = randomMatrix1(2, 0) * randomMatrix2(0, 2) + // g * l
...
TEST(Matrix3x3Tests, MultiplicationAssignmentOperator) {
	...
	{
		// r0c0
		const float expR0C0 = originalMatrix1(0, 0) * randomMatrix2(0, 0) + // a * j
		...
		// r0c1
		const float expR0C1 = originalMatrix1(0, 0) * randomMatrix2(0, 1) + // a * k
		...
		// r0c2
		const float expR0C2 = originalMatrix1(0, 0) * randomMatrix2(0, 2) + // a * l
	...
	{
		// r1c0
		const float expR1C0 = originalMatrix1(1, 0) * randomMatrix2(0, 0) + // d * j
		...
		// r1c1
		const float expR1C1 = originalMatrix1(1, 0) * randomMatrix2(0, 1) + // d * k
		...
		// r1c2
		const float expR1C2 = originalMatrix1(1, 0) * randomMatrix2(0, 2) + // d * l
	...
	{
		// r2c0
		const float expR2C0 = originalMatrix1(2, 0) * randomMatrix2(0, 0) + // g * j
		...
		// r2c1
		const float expR2C1 = originalMatrix1(2, 0) * randomMatrix2(0, 1) + // g * k
		...
		// r2c2
		const float expR2C2 = originalMatrix1(2, 0) * randomMatrix2(0, 2) + // g * l
